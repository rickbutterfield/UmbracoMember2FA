...
{
    // This is an almost like-for-like copy of Umbraco's `UmbRegisterController`
    public class RegisterController : SurfaceController
    {
        ...
        public async Task<IActionResult> Register([Bind(Prefix = "registerModel")] RegisterModel model)
        {
        ...
        private async Task<IdentityResult> RegisterMemberAsync(RegisterModel model)
        {
            ...
            {
                var existingLogins = await _memberManager.GetLoginsAsync(identityUser);
